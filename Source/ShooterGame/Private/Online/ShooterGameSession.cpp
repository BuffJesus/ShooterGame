...
void AShooterGameSession::ChooseBestSession()
{
	...
	int32 NextSessionIdx = CurrentSessionParams.BestSessionIdx + 1;
	
	if (NextSessionIdx < SearchSettings->SearchResults.Num())
	{
		// Found the next valid session
		CurrentSessionParams.BestSessionIdx = NextSessionIdx;
	}
	else
	{
