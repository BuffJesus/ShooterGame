...
void FShooterOptions::Construct(ULocalPlayer* InPlayerOwner)
{
	...
	{
		NVIDIAReflexOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("NVIDIA Reflex Low Latency", "NVIDIA REFLEX LOW LATENCY"), NVReflexList, this, &FShooterOptions::NVIDIAReflexChanged);
		LatencyFlashIndicatorOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("Latency Flash Indicator", "LATENCY FLASH INDICATOR"), OnOffList, this, &FShooterOptions::LatencyFlashIndicatorChanged);
		FramerateOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("Show frame rate", "CLIENT FPS"), ShowHideList, this, &FShooterOptions::FramerateOptionChanged);
		GameToRenderOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("Show game to render latency", "GAME TO RENDER LATENCY"), ShowHideList, this, &FShooterOptions::GameToRenderOptionChanged);
		GameLatencyOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("Show game latency", "GAME LATENCY"), ShowHideList, this, &FShooterOptions::GameLatencyOptionChanged);
		RenderLatencyOption = MenuHelper::AddMenuOptionSP(OptionsItem, LOCTEXT("Show render latency", "RENDER LATENCY"), ShowHideList, this, &FShooterOptions::RenderLatencyOptionChanged);
	}
#endif
...
void FShooterOptions::NVIDIAReflexChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
	NVIDIAReflexOpt = MultiOptionIndex;
}

void FShooterOptions::LatencyFlashIndicatorChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
	LatencyFlashIndicatorOpt = MultiOptionIndex;
}

void FShooterOptions::FramerateOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
	FramerateOpt = MultiOptionIndex;
}

void FShooterOptions::GameToRenderOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
	GameToRenderOpt = MultiOptionIndex;
}

void FShooterOptions::GameLatencyOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
	GameLatencyOpt = MultiOptionIndex;
}

void FShooterOptions::RenderLatencyOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex)
{
