...
#endif
#ifndef SETTING_MATCHING_HOPPER
#define SETTING_MATCHING_HOPPER FName(TEXT("MATCHINGHOPPER"))
#endif
#ifndef SETTING_MATCHING_TIMEOUT
#define SETTING_MATCHING_TIMEOUT FName(TEXT("MATCHINGTIMEOUT"))
#endif
#ifndef SETTING_SESSION_TEMPLATE_NAME
#define SETTING_SESSION_TEMPLATE_NAME FName(TEXT("SESSIONTEMPLATENAME"))
#endif
#ifndef SEARCH_MATCHMAKING_QUEUE
#define SEARCH_MATCHMAKING_QUEUE FName(TEXT("MATCHMAKINGQUEUE"))
#endif
// UE5: SEARCH_XBOX_LIVE_* are deprecated, use SETTING_MATCHING_HOPPER and SETTING_SESSION_TEMPLATE_NAME instead
...
#if (defined(PLATFORM_PS4) && PLATFORM_PS4) || MAX_LOCAL_PLAYERS == 1
...
void FShooterMainMenu::BeginQuickMatchSearch()
{
	...
	// UE5: Use SETTING_MATCHING_HOPPER instead of deprecated SEARCH_XBOX_LIVE_HOPPER_NAME
	QuickMatchSearchSettings->QuerySettings.Set(SETTING_MATCHING_HOPPER, FString("TeamDeathmatch"), EOnlineComparisonOp::Equals);
	// UE5: Use SETTING_SESSION_TEMPLATE_NAME instead of deprecated SEARCH_XBOX_LIVE_SESSION_TEMPLATE_NAME
...
#if (defined(PLATFORM_PS4) && PLATFORM_PS4) || MAX_LOCAL_PLAYERS == 1 || !SHOOTER_SUPPORTS_OFFLINE_SPLIT_SCREEEN
...
void FShooterMainMenu::OnMatchmakingComplete(FName SessionName, const FOnlineError& ErrorDetails, const FSessionMatchmakingResults& Results)
{
	...
	UE_LOG(LogOnline, Log, TEXT("OnMatchmakingComplete: Session host is %s."), *MatchmadeSession->OwningUserId->ToString());
