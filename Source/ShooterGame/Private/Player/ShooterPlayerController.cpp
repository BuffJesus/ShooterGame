...
{		
	...
	{
		const FText LocalReturnReason	= NSLOCTEXT( "NetworkErrors", "HostQuit", "The host has quit the match." );
		const FText OKButton		= NSLOCTEXT( "DialogButtons", "OKAY", "OK" );

		SGI->ShowMessageThenGotoState( LocalReturnReason, OKButton, FText::GetEmpty(), ShooterGameInstanceState::MainMenu );
	}
	else
	{
