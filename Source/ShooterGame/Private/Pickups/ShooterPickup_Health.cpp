...
void AShooterPickup_Health::GivePickupTo(class AShooterCharacter* Pawn)
{
	if (Pawn)
	{
		...
		// UE5: Online Events API (FOnlineEventParms, TriggerEvent) was removed
		// The analytics/telemetry code below is disabled for UE5 compatibility
		// TODO: Replace with UE5 analytics system if needed
#if 0
